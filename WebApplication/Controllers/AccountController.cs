...
namespace WebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private SmtpClient _smtpClient = new SmtpClient
        {
            ...
            Host = "smtp.gmail.com",
            Timeout = 10000,
            Credentials = new System.Net.NetworkCredential("fakefeikazure@gmail.com", "qwerty195")
        };
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.Username.ToHtmlString(), model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var mail = new MailMessage("noreply@fakefeik.azurewebsites.net", user.Email)
                    {
